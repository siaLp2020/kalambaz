...
const stages = [
  ...
  { name: 'رنگ‌های جادویی', icon: '🌈', items: [['🔴','قرمز','red','رنگ آتش و سیب است.'],['🔵','آبی','blue','رنگ آسمان و دریاست.'],['🟡','زرد','yellow','رنگ خورشید و موز رسیده است.'],['🟢','سبز','green','رنگ چمن و برگ‌های تازه است.'],['🟣','بنفش','purple','رنگی میان آبی و قرمز است.'],['🟠','نارنجی','orange','رنگ پرتقال و غروب آفتاب است.'],['🩷','صورتی','pink','رنگی روشن و نزدیک به رنگ گل رز است.'],['⚫','سیاه','black','تیره‌ترین رنگ است و مانند شب دیده می‌شود.'],['⚪','سفید','white','رنگ برف و شیر است.'],['🟤','قهوه‌ای','brown','رنگ چوب و خاک است.'],['🩶','خاکستری','gray','رنگی میان سیاه و سفید است.'],['🔹','فیروزه‌ای','cyan','رنگی روشن میان آبی و سبز است.']] },
]
const allStages = Array.from({ length: 9 }, (_, i) => stages[i % stages.length])
...
const categories = [
  ...
  makeCategory('رنگ‌های جادویی', '🌈', 'رنگ', '🔴|قرمز|red|رنگ آتش و سیب است.|3-red.wav;🔵|آبی|blue|رنگ آسمان و دریاست.|3-blue.wav;🟡|زرد|yellow|رنگ خورشید و موز رسیده است.|3-yellow.wav;🟢|سبز|green|رنگ چمن و برگ‌های تازه است.|3-green.wav;🟣|بنفش|purple|رنگی میان آبی و قرمز است.|3-purple.wav;🟠|نارنجی|orange|رنگ پرتقال و غروب آفتاب است.|3-orange.wav;🩷|صورتی|pink|رنگی روشن و نزدیک به رنگ گل رز است.;⚫|سیاه|black|تیره‌ترین رنگ است و مانند شب دیده می‌شود.;⚪|سفید|white|رنگ برف و شیر است.;🟤|قهوه‌ای|brown|رنگ چوب و خاک است.;🩶|خاکستری|gray|رنگی میان سیاه و سفید است.;🔹|فیروزه‌ای|cyan|رنگی روشن میان آبی و سبز است.', ['رنگی زیبا و چشم‌نواز است.', 'در نقاشی استفاده می‌شود.', 'با رنگ‌های دیگر ترکیب می‌شود.', 'در طبیعت دیده می‌شود.', 'شاد و روشن است.', 'آرام و دوست‌داشتنی است.']),
  makeCategory('وسایل نقلیه', '🚗', 'وسیله نقلیه', '🚗|ماشین|car|وسیله‌ای چهارچرخ است که مردم را در خیابان جابه‌جا می‌کند.;🚌|اتوبوس|bus|وسیله‌ای بزرگ است که مسافران زیادی را حمل می‌کند.;🚆|قطار|train|چند واگن دارد و روی ریل حرکت می‌کند.;✈️|هواپیما|airplane|بال و موتور دارد و در آسمان پرواز می‌کند.;🚁|هلیکوپتر|helicopter|پره‌های بزرگی دارد و می‌تواند درجا پرواز کند.;🚲|دوچرخه|bicycle|دو چرخ و رکاب دارد و با نیروی پا حرکت می‌کند.;🏍️|موتورسیکلت|motorcycle|دو چرخ و موتور دارد و سریع حرکت می‌کند.;🛴|اسکوتر|scooter|وسیله‌ای کوچک است که با پا یا موتور حرکت می‌کند.;🚤|قایق|boat|وسیله‌ای است که روی آب شناور می‌ماند.;🚢|کشتی|ship|کشتی بزرگی است که مسافر یا بار جابه‌جا می‌کند.;🚢|زیردریایی|submarine|وسیله‌ای است که زیر آب حرکت می‌کند.;🚀|موشک|rocket|با نیروی زیاد به سوی فضا پرتاب می‌شود.;🚜|تراکتور|tractor|وسیله‌ای نیرومند برای کار در مزرعه است.;🚚|کامیون|truck|خودروی بزرگی است که بار حمل می‌کند.;🚑|آمبولانس|ambulance|خودروی امدادی است که بیماران را به بیمارستان می‌رساند.', ['برای جابه‌جایی استفاده می‌شود.', 'می‌تواند سریع حرکت کند.', 'چرخ یا بال دارد.', 'آدم‌ها را به مقصد می‌رساند.', 'صدای جالبی دارد.', 'در خیابان یا آسمان دیده می‌شود.']),
  makeCategory('لباس و پوشیدنی‌ها', '👕', 'لباس', '👕|پیراهن|shirt|لباسی است که بالاتنه را می‌پوشاند و معمولاً آستین دارد.;👖|شلوار|pants|لباسی دوپاچه است که پاها را می‌پوشاند.;👗|لباس|dress|لباسی یک‌تکه است که از شانه تا پا یا زانو می‌رسد.;👗|دامن|skirt|لباسی است که دور کمر بسته می‌شود و پاها را آزاد می‌گذارد.;🧥|پالتو|coat|لباس ضخیمی است که برای گرم‌شدن روی لباس‌ها می‌پوشیم.;🧥|کاپشن|jacket|لباسی آستین‌دار است که معمولاً کوتاه‌تر از پالتوست.;🧶|پلیور|sweater|لباس بافتنی گرمی است که در هوای سرد می‌پوشیم.;🧥|هودی|hoodie|لباسی راحت است که کلاه متصل دارد.;👕|تی‌شرت|tshirt|پیراهنی سبک و معمولاً آستین‌کوتاه است.;🩳|شلوارک|shorts|شلوار کوتاهی است که تا بالای زانو می‌رسد.;👖|شلوار جین|jeans|شلواری مقاوم از پارچهٔ جین است.;🧦|جوراب|socks|پوشیدنی‌های نرمی هستند که پاها را می‌پوشانند.', ['برای پوشیدن استفاده می‌شود.', 'رنگ و طرح زیبایی دارد.', 'ما را گرم یا خنک نگه می‌دارد.', 'به اندازه‌های مختلف ساخته می‌شود.', 'در خانه یا بیرون استفاده می‌شود.', 'به ظاهر ما زیبایی می‌دهد.']),
  makeCategory('اعضای بدن', '🧍', 'عضو بدن', '🙂|سر|head|بخشی از بدن است که مغز، چشم‌ها و گوش‌ها را در خود دارد.;💇|مو|hair|رشته‌های نرمی است که روی سر رشد می‌کند.;👁️|چشم|eye|با آن رنگ‌ها و شکل‌های اطرافمان را می‌بینیم.;👂|گوش|ear|با آن صداها را می‌شنویم و به حفظ تعادل کمک می‌کنیم.;👃|بینی|nose|برای بوکشیدن و نفس‌کشیدن استفاده می‌شود.;👄|دهان|mouth|با آن غذا می‌خوریم و حرف می‌زنیم.;🦷|دندان|tooth|دندان غذا را می‌جود و به لبخند کمک می‌کند.;👅|زبان|tongue|با آن مزه‌ها را می‌چشیم و حرف می‌زنیم.;😊|گونه|cheek|بخش نرم دو طرف صورت است.;🙂|چانه|chin|بخش پایینی صورت و زیر لب است.;🧣|گردن|neck|سر را به بدن وصل می‌کند.;💪|شانه|shoulder|جایی است که بازو به بدن وصل می‌شود.', ['برای حرکت و زندگی لازم است.', 'بخش مهمی از بدن ماست.', 'باید از آن مراقبت کنیم.', 'با آن چیزهای مختلف را حس می‌کنیم.', 'در بدن همهٔ آدم‌ها وجود دارد.', 'کار مهمی انجام می‌دهد.']),
  ...
  makeCategory('طبیعت و آب‌وهوا', '🌤️', 'پدیدهٔ طبیعت', '☀️|خورشید|sun|ستاره‌ای نزدیک به زمین است که نور و گرما می‌دهد.;🌙|ماه|moon|جرم آسمانی است که شب‌ها نور خورشید را بازتاب می‌دهد.;⭐|ستاره|star|جرم نورانی دوردستی است که در آسمان شب دیده می‌شود.;☁️|ابر|cloud|توده‌ای از قطره‌های ریز آب یا یخ در آسمان است.;🌧️|باران|rain|قطره‌های آبی است که از ابرها به زمین می‌بارد.;❄️|برف|snow|دانه‌های یخ‌زده‌ای است که در هوای سرد می‌بارد.;💨|باد|wind|هوای در حال حرکت است که گاهی آرام و گاهی شدید می‌وزد.;🌈|رنگین‌کمان|rainbow|کمانی رنگارنگ است که معمولاً پس از باران دیده می‌شود.;⚡|برق|lightning|جرقهٔ بسیار درخشان برق در آسمان است.;🌩️|رعد|thunder|صدای بلندی است که پس از برق آسمان شنیده می‌شود.;⛈️|طوفان|storm|هوای بسیار ناآرام با باد و باران شدید است.;🌫️|مه|fog|ابرِ نزدیک زمین است که دیدن را سخت می‌کند.', ['در طبیعت دیده می‌شود.', 'زیبا و شگفت‌انگیز است.', 'گاهی تغییر می‌کند.', 'در آسمان یا زمین دیده می‌شود.', 'به زندگی ما کمک می‌کند.', 'می‌تواند آرام یا پرقدرت باشد.']),
