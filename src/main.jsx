...
const makeCategory = (name, icon, prompt, source, clues) => {
  ...
  return {
    ...
    items: source.split(';').filter(Boolean).map((value, index) => {
      ...
      return [emoji, faName, enName, description, `generated/items/${categoryIndex}-${index + 1}.mp3`]
    }),
  }
}
const categories = [
